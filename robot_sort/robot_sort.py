...
class SortingRobot:
    ...
    def sort(self):
        ...
        BUBBLE SORT
        """
        #if list item is bigger than held item,
            #don't swap 
            #then move left and swap

        #if held item is bigger then list item, then swap. 
            #then move left and swap.
        ...
        while self.light_is_on() is True:
            ...
            while self.can_move_right() is True:
                ...
                #if held item's value is greater
                    self.swap_item()
                    self.move_left()
                    self.swap_item()
                    self.move_right()
                ...
                # if list item is bigger than held item or if they're equal
                #essentially repeat from above... except remove the initial swap
                    self.move_left()
                    self.swap_item()
                    self.move_right()
                    self.swap_item()
